package com.cc.myapplication.common;
...
import com.cc.myapplication.bean.Update;
...
public class UpdateManager {
    ...
    public void checkAppUpdate(Context context, final boolean isShowMsg) {
        ...
        // TODO 测试
        mUpdate = new Update();
        mUpdate.setDownload_url("http://a.wdjcdn.com/release/files/phoenix/5.14.1.12012/wandoujia-wandoujia-web_direct_binded_5.14.1.12012.apk?remove=2&append=%8B%00eyJhcHBEb3dubG9hZCI6eyJkb3dubG9hZFR5cGUiOiJkb3dubG9hZF9ieV9wYWNrYWdlX25hbWUiLCJwYWNrYWdlTmFtZSI6ImNvbS55eWRjZHV0Lm5vdGUifX0Wdj01B00007b3556");
        mUpdate.setNum_version(2);
        mUpdate.setDescription("更新了一些不为人知的秘密");
        if (mUpdate != null) {
...
//        });
    ...
    private Runnable mdownApkRunnable = new Runnable() {
        ...
        public void run() {
            try {
                String apkName = "MyApp_" + mUpdate.getVersion() + ".apk";
                String tmpApk = "MyApp_" + mUpdate.getVersion() + ".tmp";
                //判断是否挂载了SD卡
